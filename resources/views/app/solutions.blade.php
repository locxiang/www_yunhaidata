...
<style>.sf-menu li:nth-child(4) a {
        color: #fff;
    }
...
<div id="fh5co-wrapper">
    <div id="fh5co-page" style="background-color: rgba(0, 0, 0, 0.04);">
        ...
        <!-- end:fh5co-header -->
        <div class="fh5co-parallax" style="background-image: url('/templates/main/images/home-image-10.jpg');"
        ...
        <div id="fh5co-programs-section" class="fh5co-programs-height">
            <div id="divId" class="affet-left">
                <ul class="schedule meta metanav top_xxk">
                    <li>
                        <a href="#" class="active" data-sched="1">政务大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="2">质监大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="3">税务大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="4">公安大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="5">旅游大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="6">环保大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="7">教育大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="8">人社大数据解决方案</a>
                    </li>
                    <li>
                        <a href="#" data-sched="9">司法大数据解决方案</a>
                    </li>
                </ul>
            </div>
            <div id="divClass" class="affet-left">
                <ul class="schedule meta top-xxk">
                    <li>
                        <a href="#" class="active" data-sched="1">政务</a>
                    </li>
                    <li>
                        <a href="#" data-sched="2">质监</a>
                    </li>
                    <li>
                        <a href="#" data-sched="3">税务</a>
                    </li>
                    <li>
                        <a href="#" data-sched="4">公安</a>
                    </li>
                    <li>
                        <a href="#" data-sched="5">旅游</a>
                    </li>
                    <li>
                        <a href="#" data-sched="6">环保</a>
                    </li>
                    <li>
                        <a href="#" data-sched="7">教育</a>
                    </li>
                    <li>
                        <a href="#" data-sched="8">人社</a>
                    </li>
                    <li>
                        <a href="#" data-sched="9">司法</a>
                    </li>
                </ul>
            </div>
...
<script>
  $(function () {
    ...
    $('.top_xxk li').click(function () {
      ...
      var n = $(".top_xxk li").index(this)

      $(".top-xxk li a").eq(n).addClass("active")
      $(".top_xxk li a").eq(n).addClass("active")
