...
Route::group(['namespace' => 'App'], function () {
    ...
    Route::get('/products-services', 'HomeController@productsServices')->name('productsServices');
    Route::get('/central', 'HomeController@central')->name('central');
...
Route::post('/customers', 'Backend\\CustomersController@store');
