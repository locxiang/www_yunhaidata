<!DOCTYPE html>
<!--[if lt IE 7]>
<html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="zh_CN"> <![endif]-->
<!--[if IE 7]>
<html class="no-js lt-ie9 lt-ie8" lang="zh_CN"> <![endif]-->
<!--[if IE 8]>
<html class="no-js lt-ie9" lang="zh_CN"> <![endif]-->
<!--[if gt IE 8]><!-->
<html class="no-js" lang="zh_CN"> <!--<![endif]-->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>{{ bloginfo('site_name') }} - 政企大数据服务商</title>
    ...
    <!-- Superfish -->
    <link rel="stylesheet" href="/templates/main/css/superfish.css">

    <link rel="stylesheet" href="/templates/main/css/style.css">

    <link rel="stylesheet" href="/templates/main/css/bootstrap_min.css">
